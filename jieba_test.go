...
func chanToArray(ch []string) []string {
	return ch
}
...
func TestDefaultCut(t *testing.T) {
	...
	for index, content := range testContents {
		result = chanToArray(seg.CutSync(content, true))
...
func TestDefaultCutNoHMM(t *testing.T) {
	var result []string
	for index, content := range testContents {
		result = chanToArray(seg.CutSync(content, false))
...
func TestLoadUserDictionary(t *testing.T) {
	...
	words := chanToArray(seg.CutSync(sentence, true))
...
func BenchmarkCutNoHMM(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		chanToArray(seg.CutSync(sentence, false))
	}
}
...
func BenchmarkCut(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		chanToArray(seg.CutSync(sentence, true))
	}
}
